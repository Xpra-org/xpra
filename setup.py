...
if cythonize_more_ENABLED:
    ...
    if client_ENABLED and gtk3_ENABLED:
        ...
        ace("xpra.client.gtk3.gtk_client_base")
        ace("xpra.client.gtk3.gtk_client_window_base")
