...
if x11_ENABLED:
    ...
    ace("xpra.x11.bindings.fixes", "xkbfile")
    ace("xpra.x11.bindings.events", "x11,xext")
...
toggle_packages(client_ENABLED and gtk3_ENABLED, "xpra.client.gtk3", "xpra.client.gtk3.window", "xpra.client.gui")
