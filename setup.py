...
from xpra.os_util import (
    ...
    is_CentOS, is_AlmaLinux, is_RockyLinux, is_RedHat, is_OracleLinux,
    )
...
def exec_pkgconfig(*pkgs_options, **ekw):
    ...
    if not (is_Fedora() or is_Debian() or is_CentOS() or is_RedHat() or is_AlmaLinux() or is_RockyLinux() or is_OracleLinux()):
        import sysconfig
