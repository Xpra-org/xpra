...
public abstract class AbstractClient implements Runnable, Client {
	...
	public Map<String, Object> make_hello(String enc_pass) {
		...
		caps.put("keyboard", true);
		caps.put("xkbmap_layout", locale.getCountry().toLowerCase());
		log("make_hello("+enc_pass+") language ="+locale.getLanguage());
		log("make_hello("+enc_pass+") country="+locale.getCountry());
		log("make_hello("+enc_pass+") variant="+locale.getVariant());
		//keycodes=[(65307, 'Escape', 9, 0, 0), (49, '1', 10, 0, 0), (33, 'exclam', 10, 0, 1), (185.
