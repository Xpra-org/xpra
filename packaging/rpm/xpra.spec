...
- Platforms, build and packaging:
   enable `avif` support on MacOS
   hide `AMF` and `GStreamer` codec warnings on MacOS
   `pycuda` 2026.1
   add Fedora 44, remove Fedora 41
   missing X11 libraries on MacOS + silence warnings generated by bundler and setuptools
   record MacOS SBOM more reliably
