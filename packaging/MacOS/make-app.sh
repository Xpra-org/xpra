...
rm -f "./launcher"
gcc -o "./launcher" "launcher.c" -I"${JHBUILD_PREFIX}/include/python${PYVERSIONSTR}" -L"${JHBUILD_PREFIX}/lib" "-lpython${PYVERSIONSTR}" -Wl,-rpath,"@executable_path/.."
...
rm -f "${MACOS_DIR}/*bin"
#add our own one:
mv launcher "${FRAMEWORKS_DIR}/bin"
