...
buildah run $CONTAINER dnf install -y xpra-filesystem xpra-server xpra-x11 xpra-html5 python3-pyxdg dbus-daemon dbus-x11 dbus-tools desktop-backgrounds-compat --setopt=install_weak_deps=False
