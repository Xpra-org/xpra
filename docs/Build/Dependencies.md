...
| Project                                                                | Source Download Link                                    | Purpose                                                           | Client or Server    | Notes                                                |
|------------------------------------------------------------------------|---------------------------------------------------------|-------------------------------------------------------------------|---------------------|:-----------------------------------------------------|
| [lz4](https://github.com/lz4/lz4)                                      | https://github.com/lz4/lz4/releases                     | [packet compression](PacketEncoding.md)                           | both                | Strongly recommended                                 |
...
| [python-cryptography](https://cryptography.io/en/latest/)              | https://pypi.python.org/pypi/cryptography               | [Encryption](Encryption.md)                                       | both                |                                                      |
| [pyopenssl](https://github.com/pyca/pyopenssl)                         | https://pypi.org/project/pyOpenSSL/                     | [Encryption](Encryption.md)                                       | both                |                                                      |
| [python-zeroconf](https://github.com/jstasiak/python-zeroconf)         | https://pypi.org/project/zeroconf/                      | [Multicast DNS](Multicast-DNS.md) session publishing and browsing | both                |                                                      |
| [python-netifaces-plus](https://github.com/tsukumijima/netifaces-plus) | https://pypi.org/project/netifaces-plus/                | [Multicast DNS](Multicast-DNS.md) session publishing              | server              |                                                      |
...
| [openssl](https://www.openssl.org/)                                    | https://www.openssl.org/source/                         | [SSL](SSL.md)                                                     | both                |                                                      |
| [asyncssh](https://github.com/ronf/asyncssh)                           | https://pypi.org/project/asyncssh/                      | optional [SSH client](SSH.md) backend with native ProxyJump        | client              |                                                      |
| [paramiko](https://pypi.org/project/paramiko/)                         | https://pypi.org/project/paramiko/                      | default SSH client and builtin server                              | both                |                                                      |
...
| [pyopengl](http://pyopengl.sourceforge.net/)              | https://pypi.python.org/pypi/PyOpenGL#files and <br /> https://pypi.python.org/pypi/PyOpenGL-accelerate#files | [client OpenGL accelerated rendering](Client-OpenGL.md) |
...
| [libyuv](https://chromium.googlesource.com/libyuv/libyuv/)                         | https://chromium.googlesource.com/libyuv/libyuv/                                                    | [Colourspace Conversion](CSC.md)                                      | both             |
| [pycuda](https://mathema.tician.de/software/pycuda/)                               | https://pypi.python.org/pypi/pycuda                                                                 | [NVENC](NVENC.md)                                                     | server           |
| [cuda](http://www.nvidia.com/object/cuda_home_new.html)                            | https://developer.nvidia.com/cuda-toolkit                                                           | [NVENC](NVENC.md)                                                     | server           |
