...
|----------------|--------------------------------------------------------------------------------------|--------------------------------------------------|
| Control        | [control](https://github.com/Xpra-org/xpra/blob/master/xpra/server/subsystem/control.py), [controlcommands](https://github.com/Xpra-org/xpra/blob/master/xpra/server/subsystem/controlcommands.py) | n/a |
...
| RTC            | [rtc](https://github.com/Xpra-org/xpra/blob/master/xpra/server/subsystem/rtc.py)               | n/a                                              |
