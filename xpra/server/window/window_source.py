...
from xpra.codecs.codec_constants import PREFERED_ENCODING_ORDER, LOSSY_PIXEL_FORMATS, PREFERRED_REFRESH_ENCODING_ORDER
...
class WindowSource(WindowIconSource):
    ...
    def __init__(self,
        ...
        self.rgb_zlib = compression.use_zlib and encoding_options.boolget("rgb_zlib", False)     #server and client support zlib pixel compression (not to be confused with 'rgb24zlib'...)
