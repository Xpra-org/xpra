...
# Many message codes are reused by different control classes (WM_USER+n ranges),
# so where a code collides we keep the standard window message that xpra's own
# windows actually receive, rather than a control-specific alias.
WNDPROC_EVENT_NAMES = {
    0x0000: "WM_NULL",
    0x0001: "WM_CREATE",
    0x0002: "WM_DESTROY",
