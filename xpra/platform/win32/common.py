...
CreateWindowExA.argtypes = [DWORD, ATOM, LPCSTR, DWORD, c_int, c_int, c_int, c_int, HWND, HMENU, HINSTANCE, LPVOID]
...
GetWindowLongA.restype = LONG
GetWindowLongA.argtypes = [HWND, INT]
...
AdjustWindowRectEx.argtypes = [POINTER(RECT), DWORD, BOOL, DWORD]
...
LoadCursor.argtypes = [HINSTANCE, INT]
...
GetCursor.argtypes = []
GetCursor.restype = HCURSOR
DestroyCursor = user32.DestroyCursor
DestroyCursor.argtypes = [HCURSOR]
DestroyCursor.restype = BOOL
...
SetTimer.argtypes = [HWND, c_size_t, UINT, c_void_p]
SetTimer.restype = c_size_t
KillTimer = user32.KillTimer
KillTimer.argtypes = [HWND, c_size_t]
...
StretchBlt.argtypes = [HDC, c_int, c_int, c_int, c_int, HDC, c_int, c_int, c_int, c_int, DWORD]
StretchBlt.restype = BOOL
SetStretchBltMode = gdi32.SetStretchBltMode
SetStretchBltMode.argtypes = [HDC, c_int]
SetStretchBltMode.restype = c_int
