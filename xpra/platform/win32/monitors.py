...
# Native (non-GTK) monitor enumeration using the win32 API.
# This module must stay free of any `gi` import so that it can be used
# by `--backend=win32` without pulling in the GTK stack.
