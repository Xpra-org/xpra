...
from xpra.gtk_common.error import XError, XSwallowContext, xlog, xsync, xswallow
...
from xpra.x11.models.core import sanestr, gobject
...
class WindowModel(BaseWindowModel):
    ...
    def update_size_constraints(self, minw=0, minh=0, maxw=MAX_WINDOW_SIZE, maxh=MAX_WINDOW_SIZE):
        ...
        if self._setup_done and self.get_property("owner"):
            self._update_client_geometry()
