 ...
 * ABOUTME: VP8/VP9 codec constants for libva decode parsing.
 * ABOUTME: Tables are codec reference constants from WebM/GStreamer/FFmpeg. */

#ifndef XPRA_LIBVA_VPX_TABLES_H
#define XPRA_LIBVA_VPX_TABLES_H
