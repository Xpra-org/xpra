...
from libc.stdint cimport uint8_t, uint32_t, int32_t, int64_t, uintptr_t
...
DEF kCMVideoCodecType_H264 = 0x61766331       # 'avc1'
DEF kCMVideoCodecType_HEVC = 0x68766331       # 'hvc1'

DEF kCVPixelFormatType_420YpCbCr8Planar = 0x79343230            # 'y420' (I420)
DEF kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange = 0x34323076  # '420v' (NV12, video range)
DEF kCVPixelFormatType_420YpCbCr8BiPlanarFullRange = 0x34323066   # '420f' (NV12, full range)
DEF kCVPixelFormatType_32BGRA = 0x42475241                       # 'BGRA'
