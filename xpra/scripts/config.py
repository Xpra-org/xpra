...
CLIENT_OPTIONS: list[str] = [
    ...
    "xsettings", "gsettings-sync", "system-tray", "sharing", "lock",
...
PROXY_START_OVERRIDABLE_OPTIONS: list[str] = [
    ...
    "readonly", "keyboard-sync", "cursors", "bell", "notifications", "xsettings", "gsettings-sync",
