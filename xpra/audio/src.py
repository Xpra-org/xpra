...
JITTER = envint("XPRA_AUDIO_SOURCE_JITTER", 0)
SOURCE_QUEUE_TIME = get_queue_time(50, "SOURCE_")

BUFFER_TIME = envint("XPRA_AUDIO_SOURCE_BUFFER_TIME", 0)  # ie: 64
LATENCY_TIME = envint("XPRA_AUDIO_SOURCE_LATENCY_TIME", 0)  # ie: 32
BUNDLE_METADATA = envbool("XPRA_AUDIO_BUNDLE_METADATA", True)
LOG_CUTTER = envbool("XPRA_AUDIO_LOG_CUTTER", False)
