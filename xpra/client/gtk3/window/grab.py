...
class GrabWindow(GtkStubWindow):
    ...
    def may_autograb(self) -> bool:
        server_mode = self._client.get_subsystem("serverinfo")._remote_server_mode
