 ...
 *   cc -Wall -Wextra -I/tmp -o /tmp/test-xdg-activation tests/xpra/test_apps/test_xdg_activation.c /tmp/xdg-shell-protocol.c /tmp/xdg-activation-v1-protocol.c $(pkg-config --cflags --libs wayland-client)
 *
...
main(int argc, char **argv)
{
    ...
    int keepalive = argc > 1 && strcmp(argv[1], "--keepalive") == 0;
