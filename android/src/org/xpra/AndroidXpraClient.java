...
public class AndroidXpraClient extends AbstractClient {
	...
	static {
		 ...
		 * names.put(KeyEvent.KEYCODE_NUMPAD_MULTIPLY,
		 * "KEYCODE_NUMPAD_MULTIPLY");
		 * names.put(KeyEvent.KEYCODE_NUMPAD_SUBTRACT,
		 * "KEYCODE_NUMPAD_SUBTRACT"); names.put(KeyEvent.KEYCODE_NUMPAD_ADD,
		 * "KEYCODE_NUMPAD_ADD"); names.put(KeyEvent.KEYCODE_NUMPAD_DOT,
		 * "KEYCODE_NUMPAD_DOT"); names.put(KeyEvent.KEYCODE_NUMPAD_COMMA,
		 * "KEYCODE_NUMPAD_COMMA"); names.put(KeyEvent.KEYCODE_NUMPAD_ENTER,
		 * "KEYCODE_NUMPAD_ENTER"); names.put(KeyEvent.KEYCODE_NUMPAD_EQUALS,
		 * "KEYCODE_NUMPAD_EQUALS");
		 * names.put(KeyEvent.KEYCODE_NUMPAD_LEFT_PAREN,
		 * "KEYCODE_NUMPAD_LEFT_PAREN");
		 * names.put(KeyEvent.KEYCODE_NUMPAD_RIGHT_PAREN,
		 ...
		 * names.put(KeyEvent.KEYCODE_LANGUAGE_SWITCH,
		 * "KEYCODE_LANGUAGE_SWITCH"); names.put(KeyEvent.KEYCODE_MANNER_MODE,
		 * "KEYCODE_MANNER_MODE"); names.put(KeyEvent.KEYCODE_3D_MODE,
		 * "KEYCODE_3D_MODE"); names.put(KeyEvent.KEYCODE_CONTACTS,
		 * "KEYCODE_CONTACTS"); names.put(KeyEvent.KEYCODE_CALENDAR,
		 * "KEYCODE_CALENDAR"); names.put(KeyEvent.KEYCODE_MUSIC,
		 * "KEYCODE_MUSIC"); names.put(KeyEvent.KEYCODE_CALCULATOR,
		 * "KEYCODE_CALCULATOR");
		 */
	}
}
